...
public class CodeGeneratorHandle {
    ...
    public DataSourceConfig getDataSourceConfig() {
        ...
        //驱动连接的URL
        dsc.setUrl("jdbc:mysql://47.103.64.174:3306/fz_smart_office");
        //驱动名称
    ...
    public StrategyConfig getStrategyConfig() {
        ...
        //表前缀
        sc.setTablePrefix("ds_");
        //需要包含的表名，当enableSqlFilter为false时，允许正则表达式（与exclude二选一配置）
        //需要生成代码的表名
        sc.setInclude("ds_update_zkh_inventory_logs");
        //是否生成实体时，生成字段注解
    ...
    public PackageConfig getPackageConfig() {
        ...
        pc.setParent("cn.com.smart.office.datasynchronism");
        //Entity包名
